...
let s:palette.bg        = {'dark': "#1E1E1E",  'light': "#FAFAFA",  'mirage': "#1E1E1E"}
...
let s:palette.panel     = {'dark': "#1E1E1E",  'light': "#FFFFFF",  'mirage': "#272D38"}
let s:palette.guide     = {'dark': "#2D3640",  'light': "#D9D8D7",  'mirage': "#3D4751"}
let s:palette.line      = {'dark': "#262626",  'light': "#F3F3F3",  'mirage': "#242B38"}
...
" hi ColorColumn guifg=#303030 guibg=#303030
